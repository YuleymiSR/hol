...
for años in range (1,meses+1):
  c_ahorros = int(input("digite la cantidad a depositar"))
  interes = (c_ahorros + suma) * 0.1 * (meses/360*años)
  inversion_anual = c_ahorros + interes
  suma = suma + inversion_anual
  print (inversion_anual)
  print (interes) 
  print ("total inversion",suma)
